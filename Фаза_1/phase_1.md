...
> Примечание: на рынке важнее C1 и C2; C3 остаётся “затратным” критерием (Cost).
...
После нормализации TFN, умножения на веса и расчёта расстояний получены коэффициенты близости:
...
Ожидаемые веса критериев (нормированные):
...
**Расчёт итоговых баллов альтернатив** выполняется на ожидаемых оценках `m`.
Для затратного критерия **C3 (Cost)** применяется инверсия шкалы:
- `C3_inverted = 10 − C3_m`
...
[РАСЧЁТЫ](https://1drv.ms/x/c/7d74f1ca817b07c9/IQAS7f9El9fARrCsMBsoIW5MAeUwo0RaxmLpjC3J-kDCb1E?e=faaYDd)
---
